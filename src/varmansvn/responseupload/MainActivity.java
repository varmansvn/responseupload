    ...
    public void onSubmit(View view) {
    	...
    	Runnable runnable = new Runnable() {
    		...
    		private int submitData() {
    		    ...
    		    HttpPost post = new HttpPost("https://docs.google.com/forms/d/1c2ckWuXeiY-vKmKMfU9RSnEkVmlJa4LZvwrSg4_GczU/formResponse");
    		    
    		    List<BasicNameValuePair> results = new ArrayList<BasicNameValuePair>();
    		    
    		    results.add(new BasicNameValuePair("entry.1597203616", "test first name from android"));
    		    results.add(new BasicNameValuePair("entry.376115040", "test last name from android"));
    		    results.add(new BasicNameValuePair("entry.597467651", "test age from android"));
